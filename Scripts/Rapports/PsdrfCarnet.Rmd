...
kable(tab, caption = "Principales caratéristiques dendrométriques, ainsi que leur précision.",
...
ggplot(tab, aes(x=Classe, y=Vha, fill=Type)) + geom_bar(stat = "identity", position='stack') +
  scale_fill_grey(start=0, end=0.9) + MyTheme + annotate("text", label = paste("ratio =",r,"%"), x = X, y = Y, size = 4)
```
